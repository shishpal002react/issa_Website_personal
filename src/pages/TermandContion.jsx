...
const TermandContion = () => {
  ...
  const TermandContion_get = async () => {
    try {
      const res = await axios.get(
        `${BaseUrl}static/getPrivacy`
      );
  ...
  return (
    ...
    <div className="support-page-container22121">
      ...
      <div style={{ marginTop: "2rem"}} dangerouslySetInnerHTML={{__html: privacy?.privacy || ""}}>
</div>
...
<ul><li><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity)</li></ul>
