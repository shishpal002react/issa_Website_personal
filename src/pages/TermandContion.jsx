...
<ul>
  ...
  <li><p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to OasisNotes LLC, 10240 N 31st Ave suite 122.
</p></li>
  ...
  <li><p><strong>Country </strong>
   refers to: Arizona, United States</p></li>
  ...
  <li><p><strong>Service </strong>
   ...
   <li><p><strong>Usage Data </strong>
    refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p></li>
...
<ul><li>First name and last name </li></ul>
<ul><li>Phone number </li></ul>
<ul><li>Address, State, Province, ZIP/Postal code, City </li></ul>
...
<ul><li><strong>Cookies or Browser Cookies.</strong><p> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</p></li></ul>
<ul><li><strong>Web Beacons.</strong><p> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity)</p></li></ul>
...
<ul><li><strong>Necessary / Essential Cookies</strong>
...
<ul><li><strong>Cookies Policy / Notice Acceptance Cookies</strong>
<p>Type: Persistent Cookies</p>
<p>Administered by: Us</p>
...
<ul><li><strong>Functionality Cookies</strong>
<p>Type: Persistent Cookies</p>
<p>Administered by: Us</p>
